...
import org.eclipse.jface.action.Action;
/**
 * Text actions (cut, copy, paste) for the Web browser. This code had to be
 * copied from org.eclipse.ui.internal.browser because access to it from
 * other bundles is restricted.
 * <p>
 * This code is borrowed from the internal browser code (org.eclipse.ui.internal.browser)
 * by John Bradley.
 * It needed to be duplicated because the code was internal and not
 * available for reuse outside in its original form.
 */
