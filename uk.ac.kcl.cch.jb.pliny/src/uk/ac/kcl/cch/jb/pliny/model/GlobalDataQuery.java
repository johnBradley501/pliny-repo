...
public class GlobalDataQuery extends BaseQuery {
   ...
   public String getMySelectEntities(){return GlobalData.getSelectEntities();}
   public String getMySQLFrom(){return GlobalData.getSQLFrom();}
   public String getMyTableJoins(){return GlobalData.getTableJoins();}
   ...
   public ILoadableFromResultSet getMyNewDataObject(){return (ILoadableFromResultSet)new GlobalData(true);}
   public String getMyKeyName(){return "GlobalData.globalDataKey";}
   public String getEntityName() {return "GlobalData";}
}
