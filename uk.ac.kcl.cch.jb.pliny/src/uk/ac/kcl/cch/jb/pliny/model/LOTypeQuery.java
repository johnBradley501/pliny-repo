...
public class LOTypeQuery extends BaseQuery {
   ...
   public String getMySelectEntities(){return LOType.getSelectEntities();}
   public String getMySQLFrom(){return LOType.getSQLFrom();}
   public String getMyTableJoins(){return LOType.getTableJoins();}
   ...
   public ILoadableFromResultSet getMyNewDataObject(){return (ILoadableFromResultSet)new LOType(true);}
   public String getMyKeyName(){return "LOType.loTypeKey";}
   public String getEntityName() {return "LOType";}
}
