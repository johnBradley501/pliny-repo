...
public class LinkableObjectQuery extends BaseQuery {
   ...
   public String getMySelectEntities(){return LinkableObject.getSelectEntities();}
   public String getMySQLFrom(){return LinkableObject.getSQLFrom();}
   public String getMyTableJoins(){return LinkableObject.getTableJoins();}
   ...
   public ILoadableFromResultSet getMyNewDataObject(){return (ILoadableFromResultSet)new LinkableObject(true);}
   public String getMyKeyName(){return "LinkableObject.linkableObjectKey";}
   public String getEntityName() {return "LinkableObject";}
}
